...
This repo is my set up for XMonad as well as all my other dotfiles (except
Emacs which has its own repo). 

It relies on stow to farm the dotfiles in the /dotfiles folders.
